...
from yolov5.utils.general import Profile, non_max_suppression, scale_boxes, xyxy2xywh
...
def count_obj(box,w,h,id,direct,cls):
    global up_count,down_count,tracker1, tracker2, objectA_count2, objectB_count2, objectC_count2, objectA_count, objectB_count, objectC_count
...
def parse_opt():
    ...
    parser.add_argument('--tracking-method', type=str, default='deep_sort', help='deepocsort, botsort, strongsort, ocsort, bytetrack, deep_sort')
